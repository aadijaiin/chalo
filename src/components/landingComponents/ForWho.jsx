    ...
    <section className="px-6 lg:px-40 py-24 bg-white">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="group relative overflow-hidden rounded-3xl aspect-[16/10] bg-cream shadow-inner">
            <div
            ...
            ></div>
            <div className="absolute inset-0 bg-gradient-to-t from-earth/80 via-earth/20 to-transparent"></div>
